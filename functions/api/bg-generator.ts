...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  velvet: '深紅色絲絨布幔作為背景，帶有優雅的褶皺，柔和的聚光繇煥射在商品上，營造奢華感',
  metallic: '拋光不銹協金屬表面，帶有微妙的反射，冷色調的工業風格燈光，背景是深灰色漸層',
  ...
  window: '清晨的陽光透過白色紗簾灑入，窗台場景，光影交錯，溫暖而明亮的汣圍',
};
